...
func (t *TestAgent) BuildPackage(inputFile, logName, outArch string, nativeDependencies, targetDependencies []string) (builtFiles []string, logFile string, err error) {
