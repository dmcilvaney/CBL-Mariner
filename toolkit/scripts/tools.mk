...
go_scheduler2_files = $(shell find $(TOOLS_DIR)/tasker -type f -name '*.go')
go_common_files = $(go_module_files) $(go_internal_files) $(go_grapher_files) $(go_imagegen_files) $(go_pkg_files) $(go_scheduler_files) $(go_scheduler2_files) $(STATUS_FLAGS_DIR)/got_go_deps.flag $(BUILD_DIR)/tools/internal.test_coverage
